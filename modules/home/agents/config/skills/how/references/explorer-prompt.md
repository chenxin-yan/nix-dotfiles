...
Start by finding the relevant code. Use the available file discovery, code search, and read tools to inspect the actual implementation. Don't guess from names. Read the code.
